...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['template-contactform-name'] != '' AND $_POST['template-contactform-email'] != '' AND $_POST['template-contactform-message'] != '' ) {
        ...
        $subject = isset($subject) ? $subject : 'Nova mensagem do site Alyne Pattuzzo';

        $botcheck = $_POST['template-contactform-botcheck'];

        $toemail = 'contato@alynepattuzzo.com.br'; // Your Email Address
        $toname = 'Alyne Pattuzzo Make-Up'; // Your Name
